package be.tahayasin.menubook.Activities.Kiosk
...
import be.tahayasin.menubook.Activities.Splash.SplashActivity

import be.tahayasin.menubook.R
import kotlinx.android.synthetic.main.activity_kiosk.*
...
class KioskActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btStopLockTask.setOnClickListener {
            ...
            val intent = Intent(applicationContext, KioskActivity::class.java).apply {
    ...
    private fun setAsHomeApp(enable: Boolean) {
        if (enable) {
            ...
            mDevicePolicyManager.addPersistentPreferredActivity(
                    mAdminComponentName, intentFilter, ComponentName(packageName, KioskActivity::class.java.name))
        } else {
